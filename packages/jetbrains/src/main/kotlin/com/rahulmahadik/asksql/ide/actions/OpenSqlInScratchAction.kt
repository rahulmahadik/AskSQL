...
/**
 * Opens SQL text as a scratch file (the SQL block's "Open in Scratch" button), with the platform's
 * bundled SQL language when available and plain text on Community-only installs.
 */
