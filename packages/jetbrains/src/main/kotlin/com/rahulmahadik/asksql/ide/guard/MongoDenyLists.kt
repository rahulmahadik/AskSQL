...
object MongoDenyLists {
    ...
    /** Allowlist, not denylist: aggregation stages have no structural read/write split ($out looks just like $match). */
    ...
    /** Banned at any nesting depth via a full document-tree walk; these execute arbitrary server-side JavaScript. */
