...
- 560869b: Answer a question about what to change or improve in prose, rather than running a table listing. The
...
- abd7a9e: Cap a set operation at the statement rather than inside a branch: a LIMIT written
